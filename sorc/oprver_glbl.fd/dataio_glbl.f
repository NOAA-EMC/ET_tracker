...
c         formal parameters
      ...
      read( datFile, '(10x,a2,a8,17x,f3.1,a1,2x,f4.1,a1,2x,i3)', 
...
!      character*2       cycnum
      ...
      read( datFile, '(a2,2x,a4,2x,a2,a8,17x,f3.1,a1,2x,f4.1,a1,2x,i3)',
...
c         formal parameters
      ...
      character*2       bttype
      integer           ios
      integer, intent(inout), optional :: pres
c
c         local variables
      type (AID_DATA) btRcd
      integer         readStat
...
c     Read the next record in the data file.
      ...
      if( readStat .eq. 1 ) then
         ...
         if ( present(pres) ) then pres = btRcd%aRecord(1)%mslp
      endif
...
c
      ...
      call writeAid( datFile, oldstormID, stormID(5:6), cdtg(3:10),
     &     techname, ltlnwnd )
C
      END
