...
c   2012-5-17  GuangPing Lou - Modified to port the code to zeus
c
c Input files:
...
c
     ...
     &      ,'  hhmm= ',hhmm
      ...
      do while (.true.)
       ...
       ts%tcv_center=rd_atcf(1:4)
       ts%tcv_storm_id=rd_atcf(6:8)
       ts%tcv_storm_name=rd_atcf(10:18)
       read(rd_atcf(20:21),'(i2)') ts%tcv_century
       read(rd_atcf(22:27),'(i6)') ts%tcv_yymmdd
       read(rd_atcf(29:32),'(i4)') ts%tcv_hhmm
       read(rd_atcf(34:36),'(i3)') ts%tcv_lat
       ts%tcv_latns=rd_atcf(37:37)
       read(rd_atcf(39:42),'(i4)') ts%tcv_lon
       ts%tcv_lonew=rd_atcf(43:43)
       read(rd_atcf(45:47),'(i3)') ts%tcv_stdir
       read(rd_atcf(49:51),'(i3)') ts%tcv_stspd
       ts%tcv_chunk=rd_atcf(52:150)

      print*, 'rd_atcf(1)= ', rd_atcf
!      print*, 'ts(1)= ', ts
